...
import GifPopoverContent from "./_gif-popover-content.jsx";
import MentionPopverContent from "./_mention-popover-content.jsx";
...
const CommentForm = ({ postId }) => {
  ...
  return (
    <div className="max-md:hidden flex gap-2 items-center w-full relative">
      <Popover
        position="top-left"
        triggerContent={<MdOutlineGifBox className="text-[28px]" />}
        popoverClassName={
          "p-3 z-50 bg-[gray] w-screen sm:w-[300px] h-[500px] sm:h-[400px] overflow-y-scroll"
        }
      ...
      <Popover
        position="top-right"
        popoverClassName={
          "p-3 z-[100] bg-[gray] w-screen sm:w-[250px] h-[500px] sm:h-[400px] overflow-y-scroll"
        }
